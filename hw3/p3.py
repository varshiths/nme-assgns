...
def main():
    ...
    weights, delays = get_connectivity_matrices(N, w0, -w0/gamma)
    ...
    with open("P3.spikes.pickle", "wb") as f:
        pickle.dump(spikes, f)
    with open("P3.spikes.pickle", "rb") as f:
        spikes = pickle.load(f)

    plot_spikes(spikes, "P3.0.png")
    plot_nspikes_t(spikes, "P3.1.png", "P3.2.png")
    # for i in range(N):
