...
def main():
    ...
    with open("P5.spikes.pickle", "wb") as f:
        pickle.dump([spikes, aweights], f)
    with open("P5.spikes.pickle", "rb") as f:
        spikes, aweights = pickle.load(f)

    plot_spikes(spikes, "P5.0.png")
    plot_nspikes_t(spikes, "P5.1.png", "P5.2.png")
    plot_weights_trace(aweights, "P5.3.png")
    # for i in range(N):
